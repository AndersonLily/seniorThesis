    ...
    if(data_of_original === data_of_bugged){
        ...
        for(let counter = 0; counter < data_of_original.length; counter++){
            ...
            if(data_of_original.at(counter + offset_for_the_orignal_string) != data_of_bugged.at(counter  + offset_for_the_bugged_string)){
                ...
                while((counter + offset_for_the_bugged_string) < data_of_bugged.length && (data_of_original.at(old_counter + offset_for_the_orignal_string) != data_of_bugged.at(counter + offset_for_the_bugged_string) || data_of_original.at(old_counter + offset_for_the_orignal_string + 1) != data_of_bugged.at(counter + offset_for_the_bugged_string + 1) )){
                    counter++;
                ...
                while((counter) < data_of_original.length - 1 && (data_of_original.at(counter + offset_for_the_orignal_string) != data_of_bugged.at(old_counter + offset_for_the_bugged_string) ||  data_of_original.at(counter  + offset_for_the_orignal_string+ 1) != data_of_bugged.at(old_counter + offset_for_the_bugged_string + 1))){
                    counter++;
                    if(data_of_original.at(counter + offset_for_the_orignal_string) == data_of_bugged.at(old_counter + offset_for_the_bugged_string) && data_of_original.at(counter  + offset_for_the_orignal_string+ 1) == data_of_bugged.at(old_counter + offset_for_the_bugged_string + 1)){
        ...
        if(data_of_original.length <= data_of_bugged.length){
        if(offset_for_the_bugged_string == 0 || (data_of_bugged.length - (data_of_original.length - offset_for_the_orignal_string)) != offset_for_the_bugged_string){
            return_string = return_string.substr(0, (data_of_original.length  - offset_for_the_orignal_string + offset_for_return_string + offset_for_the_bugged_string)) + bug_message + data_of_bugged.substr((data_of_original.length - offset_for_the_orignal_string + offset_for_the_bugged_string + 1), data_of_bugged.length);
        }
    } else{

        if(offset_for_the_orignal_string == 0 || (data_of_original.length - (data_of_bugged.length + offset_for_the_bugged_string)) != offset_for_the_orignal_string){
            return_string = return_string.substr(0, (data_of_original.length  - offset_for_the_orignal_string + offset_for_return_string + offset_for_the_bugged_string)) + bug_message + data_of_bugged.substr((data_of_original.length - offset_for_the_orignal_string + offset_for_the_bugged_string + 1), data_of_bugged.length);
        }
    }
...
function reveal_added_bugs(){
    ...
    for(let counter = 0; counter < filesToModify.length; counter++){
        ...
        let test6 = compare_the_files("Test Original string things have not been altered here", "Test Original things have not been altered here");
         console.log(test6);

        let test7 = compare_the_files("Test Original string things have not been altered here", "Test Original string have not been altered here");
        console.log(test7);

        let test8 = compare_the_files("Test Original string things have not been altered here", "Test Original string have been altered here");
        console.log(test8);

        let test9 = compare_the_files("Test Original string things have not been altered here", "Test Original string things have not been altered");
        console.log(test9);

        let test10 = compare_the_files("Test Original string things have not been altered here", "Test Original string things have not nyx been altered");
        console.log(test10);
    }
}
